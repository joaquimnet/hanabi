...
module.exports = new Listener({
  words: ['{me}', '(would|want|wanna)', '(be|feel)', '(pretty|beautiful|gorgeous|handsome|lovely|cute|cool)'],
  category: 'ED',
  cooldown: 6000,
  priority: 0,
  async run(bot, message, meta) {
    ...
    await bot.wait(500)
    meta.respond("Hey there. I understand how you feel. Let me tell you something:orange_heart:");
    message.channel.startTyping().catch(() => {});
    await bot.wait(3000)
    meta.respond(
    ...
    message.channel.startTyping().catch(() => {});
    await bot.wait(5000)
    meta.respond("With that being said, it **is** okay and completely valid to feel the way you do, we all experience it.",
